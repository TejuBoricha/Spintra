          ...
          {availableGames.map((g) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center gap-2 p-4 min-h-36 text-center rounded-xl border transition-all text-sm font-medium hover:border-primary/50 hover:bg-primary/10 ${
