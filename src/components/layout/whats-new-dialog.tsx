...
export function WhatsNewButton({
   ...
   *  entries (Settings, Live Rooms, ...) — same shared dialog/seen-state
   *  either way, just a different trigger, so opening one from either
   *  breakpoint always dismisses the same badge. */
  variant?: "icon" | "full";
  /** Mobile menu callback to close the hamburger panel once the dialog opens. */
  onNavigate?: () => void;
}) {
